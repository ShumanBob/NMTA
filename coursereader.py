...
def main():
        ...
        with open("CSEPROJECT\courses.txt", 'r', encoding='utf-8') as file:
                content = file.read()
        ...
        # Used to write to csv for HTML purposes
        with open("course_csv.csv", "w") as file:
                writer = csv.writer(file)

                writer.writerow(["Course Code", "Course Name", "Days", "Times"]) 
